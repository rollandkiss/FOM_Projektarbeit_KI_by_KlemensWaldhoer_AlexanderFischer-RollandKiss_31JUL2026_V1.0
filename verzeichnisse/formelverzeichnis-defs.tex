...
\glsxtrnewsymbol[sort={i}, description={Laufindex der Summation über die
    Fensterlänge des gleitenden Durchschnitts}]{symI}{\ensuremath{i}}
...
\glsxtrnewsymbol[sort={h}, description={erwartete absolute Tagesbewegung der
    Position (Produkt aus Hebel und mittlerer absoluter
    Index-Tagesbewegung)}]{symH}{\ensuremath{h}}
...
\glsxtrnewsymbol[sort={p}, description={Trefferquote: Anteil der Handelstage
    mit Kursbewegung in Signalrichtung (Bruttogröße des
    Rentabilitätsmodells)}]{symP}{\ensuremath{p}}
