...
gegen eine zweite Bezugsquelle geprüfte Erfassung von Marktdaten und die
...
gelegte Rahmen ausdrücklich mit dem automatisierten Handel als Anwendungsbeispiel
verbindet.\zit[S.~18]{bitkom2018} Ergänzend sichern eine
...
Tagesbars verdichtet. Der jeweils jüngste Tagesschluss wird gegen die
Referenzreihe der Federal Reserve Bank of St.\ Louis (\glsxtrshort{fred}) abgeglichen; Divergenzen
...
durchspielen; der vollständige Quellcode einschließlich der Testsuiten liegt
der Arbeit als elektronisches Archiv bei, dessen Aufbau und Inhalt
Anhang~\ref{cha:anhang-archiv} dokumentiert.
...
Anhang~\ref{sec:anhang-evaluationsbelege} dokumentiert. Der Strategie werden drei Vergleichsmaßstäbe gegenübergestellt:
...
Kursdatenquelle bietet keine Verfügbarkeitsgarantie. Die Gegenprüfung ist
begrenzt: Beide Reihen entstammen derselben Indexberechnung und prüfen daher den
Übertragungsweg, nicht den Indexstand; die Referenzreihe reicht lizenzbedingt nur
zehn Jahre zurück. Trotz Temperatur null und
...
zunächst nur beobachtend gemessen werden kann.
...
Bemerkenswert ist die Herkunft dieser Sicherungen: Die Wächterprozesse gegen stille
Verbindungsabbrüche ebenso wie die tagesgenaue Gegenprüfung der Kursreihe waren im
Entwurf nicht vorgesehen, sondern wurden durch Fehlerbilder des laufenden Betriebs
erzwungen und anschließend in den Offline-Testsuiten festgeschrieben. Die
Sicherungskette eines autonom handelnden Agenten lässt sich demnach nicht
vollständig vorab bestimmen; sie bleibt an Betriebserfahrung gebunden.
