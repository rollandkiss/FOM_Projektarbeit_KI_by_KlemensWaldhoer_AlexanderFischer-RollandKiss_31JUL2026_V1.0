...
\begin{longtable}{@{}p{0.29\textwidth}p{0.155\textwidth}p{0.455\textwidth}@{}}
  ...
  \texttt{webfeed/\allowbreak app/\allowbreak static/\allowbreak chart.umd.js} & Fremd-bibliothek & FREMDCODE, nicht eigene Leistung: Chart.js v4.4.3 (MIT-Lizenz, unveraendert uebernommen, chartjs.org). Liegt bei, weil das Dashboard die Bibliothek bewusst selbst ausliefert statt ueber ein CDN und test\_app.py genau das prüft \\
