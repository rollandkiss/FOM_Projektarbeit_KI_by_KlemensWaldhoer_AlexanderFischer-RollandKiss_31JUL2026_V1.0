...
\begin{longtable}{@{}p{0.28\textwidth}p{0.17\textwidth}p{0.45\textwidth}@{}}
  ...
  \texttt{belege\_\allowbreak echtgeldwoche/\allowbreak cron\_\allowbreak echtgeldwoche.log} & 30.07.2026 & Protokoll der werktäglichen Zyklen der Echtgeld-Woche (27.–30.07.2026): Mengenbildung, Ordererteilung, Stornierungen und Schutzorderpflege im Wortlaut des Laufzeitprotokolls — Order-Kennungen pseudonymisiert \\
  \texttt{belege\_\allowbreak echtgeldwoche/\allowbreak decisions\_\allowbreak haupt.csv} & 30.07.2026 & Entscheidungsjournal des Hauptdepots (Strategie sma): Anfrage an die Sprachmodelle, unveränderte Modellantworten, Mehrheitsentscheid und Validatorbefund je Handelstag \\
  \texttt{belege\_\allowbreak echtgeldwoche/\allowbreak decisions\_\allowbreak zweit.csv} & 30.07.2026 & Entscheidungsjournal des Zweitdepots (Strategie smatrend), gleiche Struktur — enthält den Fall einer NO\_TRADE-Mehrheit mit Early-Stop des dritten Modells \\
  \texttt{belege\_\allowbreak echtgeldwoche/\allowbreak protection\_\allowbreak haupt.csv} & 30.07.2026 & Ereignisprotokoll der Schutzorder (Auflösung vor dem Kauf, Neusetzung danach) mit Auslöseschwelle, Abstand und Stückzahl — Belegkette zu den Zyklen des Cron-Protokolls \\
  \texttt{belege\_\allowbreak echtgeldwoche/\allowbreak schema\_\allowbreak decisions.txt} & 30.07.2026 & Tabellendefinition des Entscheidungsjournals — macht die Spalten der beiden Journalauszüge ohne Codelektüre nachvollziehbar \\
