...
Auf der Ebene der Wahrnehmung stützt sich der Agent auf die kontinuierliche,
gegen eine unabhängige Zweitquelle geprüfte Erfassung von Marktdaten und die
Erkennung von Trendmustern in der Kurszeitreihe. Auf der Ebene der
Schlussfolgerung prüft ein Gremium aus drei großen Sprachmodellen die
regelbasiert vorbereitete Entscheidung jeweils unabhängig und begründet; harte
Ausschlusskriterien entscheiden deterministische Vorprüfungen bereits vor dem
ersten Modellaufruf. Auf der Ebene der Reaktion ordnet sich das Vorhaben
unmittelbar dem Element der prozesssteuernden Kontrolle zu, das der zugrunde
gelegte Rahmen ausdrücklich mit dem Börsenhandel als Anwendung
verbindet.\footcite[vgl.][S.~19]{waldhoerKI2025} Ergänzend sichern eine
Kommunikationskomponente die Rückbindung an den Menschen -- tägliche Freigabe der
Banksitzung, Berichte, jederzeit wirksamer Not-Aus -- und ein öffentliches,
redigiertes Dashboard die Transparenz der Entscheidungs- und Wertentwicklung.
...
Prognose künftiger Kurse und nicht zur erfahrungsbasierten Selbstveränderung
eingesetzt. Das Element der prognostischen Inferenz, das in Finanzanwendungen
üblicherweise die Signalquelle stellt, ist stattdessen in umgekehrter Rolle besetzt:
Ein einfaches statistisches Prognosemodell wirkt ausschließlich als zusätzlicher
Risikohinweis für das Prüfgremium; das Element der erfahrungsbasierten
Fortschreibung des eigenen Wissens bleibt bewusst unbesetzt. Das Gremium
kann Handelsvorschläge ausschließlich verhindern, verkleinern oder zeitlich einordnen,
niemals erzeugen oder in ihrer Richtung umkehren. Die
eigentliche gestalterische Aussage der Arbeit liegt somit in der sicherheitsorientierten
Einschränkung des KI-Einsatzes, deren Ausprägung -- einschließlich des mehrstufig
abgesicherten Orderpfads -- im weiteren Verlauf des Kapitels dargelegt wird.
...
bildet.\footcite[vgl.][S.~19]{waldhoerKI2025}
...
Einer Basisrate von 52,1\,\% aufwärts gerichteter Folgetage steht eine Trefferquote
von 52,0\,\% gegenüber, und der Brier-Score von 0,2498 unterschreitet die
Klimatologie (0,2496) nicht -- das Modell besitzt keine Prognosekraft über die
Basisrate hinaus. Bemerkenswert ist, dass es dabei gut kalibriert bleibt: Im
dominierenden Wahrscheinlichkeitsbereich um 0,5 stimmen prognostizierte
(52,4\,\%) und beobachtete Häufigkeit (52,5\,\%) nahezu überein, und selbst an den
Tagen, an denen das Modell skeptisch war, stieg der Markt in 50,4\,\% der Fälle.
