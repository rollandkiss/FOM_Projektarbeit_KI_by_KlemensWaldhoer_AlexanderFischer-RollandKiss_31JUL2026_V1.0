...
\arbeitOrt, \abgabedatum &
    % Unsichtbarer Platzhalter mit den Massen der Unterschriften-Grafik
    % (Hoehe 1,1 cm, um 0,1 cm abgesenkt): das Datum sitzt dadurch -- wie im
    % Block von R. Kiss -- direkt auf der Linie. Sobald
    % abbildungen/unterschrift_alexander.svg vorliegt, den \rule-Platzhalter
    % durch die auskommentierte \includesvg-Zeile ersetzen:
    %\raisebox{-0.1cm}{\includesvg[height=1.1cm]{unterschrift_alexander}}%
    \raisebox{-0.1cm}{\rule{0pt}{1.1cm}}\\[-0.2cm]
\hrulefill & \hrulefill \\
