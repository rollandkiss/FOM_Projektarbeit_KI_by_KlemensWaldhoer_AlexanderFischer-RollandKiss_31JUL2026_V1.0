...
% ToC-Umbruch vor dem Anhang: Die Anhang-Eintraege (I, II, III) beginnen im
% Inhaltsverzeichnis auf einer neuen Seite — das mildert den Bruch zwischen
% Hauptteil und Anhang. ACHTUNG: Wenn der Hauptteil weiter waechst und der
% erzwungene Umbruch zu einem unguenstigen Layout fuehrt (z. B. sehr leere
% erste ToC-Seite), einfach die folgende EINE Zeile auskommentieren.
